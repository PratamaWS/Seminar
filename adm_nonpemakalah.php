...
<body class="skin-blue-light fixed sidebar-mini ">
  <div class="wrapper">
    <header class="main-header">
      <!-- Logo -->
      <a href="adm_nonpemakalah.php" class="logo">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              <a href="adm_nonpemakalah.php" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <a href="kategori.php">
          <i class="fa fa-th"></i> <span>Kelola Kategori</span>
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="adm_nonpemakalah.php"><i class="fa fa-circle-o"></i> Non Pemakalah</a></li>
              </ul>
            </li> 
          <li class="treeview">
              <a href="#">
