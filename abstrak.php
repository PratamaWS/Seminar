          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="abstrak.php" class="dropdown-toggle" data-toggle="dropdown">
       ...
       <li class="treeview">
        <a href="kategori.php">
          ...
          <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li  class="active"><a href="abstrak.php"><i class="fa fa-circle-o"></i> Konfirmasi Abstrak</a></li>
